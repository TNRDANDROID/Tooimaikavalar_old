package com.nic.thooimaikaavalar_old.application;
...
import com.nic.thooimaikaavalar_old.api.LruBitmapCache;
...
public class NICApplication extends Application {
    ...
    private SSLSocketFactory getSocketFactory() {
        ...
        try {
            ...
            InputStream caInput = getResources().openRawResource(R.raw.drdpr_public);
            Certificate ca;
            try {
